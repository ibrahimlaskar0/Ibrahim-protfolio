...
const SaasSection = () => {
  ...
  const wistiaVideos = [
    ...
    { mediaId: '45h1td932g', aspect: '0.5625' },
    { mediaId: 'j70q2zi1ef', aspect: '0.5625' },
    { mediaId: 'afnn2bbjer', aspect: '0.5625' },
    { mediaId: '2dkpu03tal', aspect: '0.5625' }
  ];

  // Short form page only: remove 2nd video (z8sjiwl4s7)
  const shortFormVideos = [
    { mediaId: 'viq1evrw4h', aspect: '0.5625' },     // #1
    { mediaId: 'ju1mokk26k', aspect: '0.5625' },     // #3 (skip #2)
    { mediaId: '53lneehtbg', aspect: '0.5625' },     // #3 (replaced with 53lneehtbg)
    { mediaId: '939ddqxgf4', aspect: '0.5625' },     // #4 (replaced with 939ddqxgf4)
    { mediaId: '3ru7w4jupx', aspect: '0.5633802816901409' }, // #6
    { mediaId: 'udvrrkrdc5', aspect: '0.5625' }      // #7
  ];

  // AI Avatar page: remove last 3 videos
  const aiAvatarVideos = [
    { mediaId: 'nty4on2i9a', aspect: '0.5625' },
    { mediaId: 'z8sjiwl4s7', aspect: '0.5625' },
    { mediaId: 'gnawuejqq8', aspect: '0.5625' },
    { mediaId: 'e835s9cctg', aspect: '0.5625' },
    { mediaId: 'g9fpqn3eub', aspect: '0.5625' },
    { mediaId: 't4y05g12nr', aspect: '0.5625' }
  ];
  ...
  return (
    <section className="py-20 bg-black transition-colors duration-500 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* Priority note under videos, right-aligned */}
          <div className="mt-2 md:mt-4 text-right">
            <p className="text-lg md:text-xl text-white/80 font-dm-serif">
              Priority to clients who value results over 'cheap'.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-normal max-w-2xl mx-auto">
            From concept to delivering, here are the digital products I have brought to life.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-2 md:mt-4 text-right">
            <p className="text-lg md:text-xl text-white/80 font-dm-serif">
              Designed for clarity. Built for conversion.
            </p>
          </div>
        </div>
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Avatar-Led AI Videos
          </h2>
          <p className="text-xl md:text-2xl text-gray-400 font-normal max-w-2xl mx-auto">
            Explain products without cameras, studios, or friction.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
            {aiAvatarVideos.map((video, index) => (
              <motion.div
                key={`copy2-${index}`}
                initial={{ opacity: 0, y: 50 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="mt-2 md:mt-4 text-right">
            <p className="text-lg md:text-xl text-white/80 font-dm-serif">
              Clear AI explanations, powered by intelligent avatars.
            </p>
          </div>
        </div>
